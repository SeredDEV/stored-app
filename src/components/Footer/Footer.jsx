        ...
        <div className=' flex flex-col justify-center items-center space-y-6 pt-5'>
            ...
            <div>
                <div class="flex items-center gap-6">
                    ...
                    <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds YouTube" href="https://www.youtube.com/channel/UCcjfmVnuRYd7kPCcrVlpGog" target="_blank"><svg
                    ...
                    <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Facebook" href="https://www.facebook.com/seredismo9510" target="_blank"><svg
                    ...
                    <a class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Instagram" href="https://www.instagram.com/sered9505/" target="_blank"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-8">
                        <path fill="currentColor"
